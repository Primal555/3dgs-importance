...
from test_position_delivery import explicit_model
...
class LocalResponseTests(unittest.TestCase):
    ...
    def fixture(self):
        ...
        raw,g,f,base=setup(16)
        return raw,g,f,explicit_model(base,'quantized')
    ...
    def test_high_order_sh_and_extreme_anisotropy_finite(self):
        ...
        m=GaussianCodec(CodecConfig(architecture='learned_joint',loss_profile='learned_v1',
                                   position_delivery='quantized',sh_degree=3,hidden=16,depth=1,
